...
<html>
  ...
  <div class="container-fluid">
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><img src="./images/kec logo.jpg" width="50%"> </td>
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                 KONGU ENGINEERING COLLEGE, PERUNDURAI ERODE-638060,TAMILNADU,INDIA</font></center>
                
                <center><font style="font-family:Verdana; font-size:18px;">
                Mobile:9965277765,9443020583
                    </font></center>
                       ...
                       <table class="table table-hover">
                           ...
                           <tr>
                               <td><font style="font-family: Verdana;">Medium of Instruction till class 12th</font></td>
                                    ...
                                    <td colspan="3"><?php echo $row[51] ?></td>
                           ...
                           <tr>
                               ...
                               <td colspan="3"><?php echo $row[52] ?></td>
