     ...
     <body style="background-image:url('./images/inbg.jpg');">
        <form id="adform" action="admsnform.php" method="post">
            ...
            <table class="frmtbl">
               ...
               <tr>
                     <td><font style="font-family: Verdana;">UG College Name</font></td>
                ...
                <tr>
                     ...
                     <td><input type="text" id="cen" name="cen" required="true"></td>
                ...
                <tr>
                     <td><font style="font-family: Verdana;">% in UG</font></td>
                   ...
                   <td colspan="3">
                       <table class="table table-hover">
                           ...
                           <tr>
                               ...
                               <td><input type="text" id="yop3" name="yop3" class="actab" required="true"></td>
                               <td><input type="text" id="tm3" name="tm3" class="actab" required="true"></td>
                               <td><input type="text" id="mo3" name="mo3" class="actab" required="true"></td>
                               <td><input type="text" id="divs3" name="divs3" class="actab" required="true"></td>
                               <td><input type="text" id="pom3" name="pom3" class="actab" required="true"></td>
                           </tr>
