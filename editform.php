...
s_twltotmark='$tm2', s_twlmarkob='$mo2', s_twldiv='$divs2', s_twlprcmark='$pom2',
s_ugbrd='$nob3', s_ugyop='$yop3', s_ugtotmark='$tm3', s_ugmarkob='$mo3',
s_ugdiv='$divs3', s_ugprcmark='$pom3', s_moi='$moi', s_pay='$pay'
     ...
     <body style="background-image:url('./images/inbg.jpg');">
        <form id="edform" action="editform.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/kec1.png" height="175px" width="2000px" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
             </div>
            ...
            <table class="frmtbl">
                ...
                <tr>
                    <td colspan="4"><input type="radio" id="cat" name="cat" value="SC"><font style="font-family: Verdana;">
                        ...
                        <input type="radio" id="cat" name="cat" value="OBC"><font style="font-family: Verdana;">BC</font>
                        <input type="radio" id="cat" name="cat" value="GEN"><font style="font-family: Verdana;">OTHERS</font></td>
                 </tr>
               ...
               <tr>
                     ...
                     <td><input type="text" id="col" name="col" value="<?php echo $row[29] ?>"></td>
                    
                </tr>
              
                <tr>
                     <td><font style="font-family: Verdana;">Center for exam</font></td>
                     <td><input type="text" id="cen" name="cen" value="<?php echo $row[30] ?>"></td>
                     
                </tr>
                
                <tr>
                     <td><font style="font-family: Verdana;">Aadhaar Number</font></td>
                     <td><input type="text" id="crsty" name="crsty" required="true"></td>
                   ...
                   <td colspan="3">
                       <table class="table table-hover">
                           ...
                           <tr>
                               ...
                               <td><input type="text" id="yop3" name="yop3" class="actab" value="<?php echo $row[46] ?>"></td>
                               <td><input type="text" id="tm3" name="tm3" class="actab" value="<?php echo $row[47] ?>"></td>
                               <td><input type="text" id="mo3" name="mo3" class="actab" value="<?php echo $row[48] ?>"></td>
                               <td><input type="text" id="divs3" name="divs3" class="actab" value="<?php echo $row[49] ?>"></td>
                               <td><input type="text" id="pom3" name="pom3" class="actab" value="<?php echo $row[50] ?>"></td>
                           </tr>
                           ...
                           <tr>
                               <td><font style="font-family: Verdana;">Medium of Instruction till class 12th</font></td>
                               <td colspan="3">
                                    <input type="radio" id="moi" name="moi" value="Tamil"><font style="font-family: Verdana;">Tamil</font>
                                    <input type="radio" id="moi" name="moi" value="Malayalam"><font style="font-family: Verdana;">Malayalam</font>
