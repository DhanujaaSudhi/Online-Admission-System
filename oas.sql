...
CREATE TABLE IF NOT EXISTS `t_user` (
  ...
  `s_ugbrd` varchar(7) NOT NULL,
  `s_ugyop` varchar(4) NOT NULL,
  `s_ugtotmark` varchar(4) NOT NULL,
  `s_ugmarkob` varchar(4) NOT NULL,
  `s_ugdiv` varchar(4) NOT NULL,
  `s_ugprcmark` varchar(4) NOT NULL,
